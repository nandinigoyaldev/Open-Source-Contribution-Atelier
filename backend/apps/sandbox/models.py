...
class SandboxExecutionLog(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, help_text="When the attempt was made.")
    ...
    def __str__(self):
        ...
        return f"[{'Accepted' if self.accepted else 'Rejected'}] {username}: {cmd_preview}"
