...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        permissions_data = [
            ...
            {"slug": "create_content", "description": "Can create learning modules and challenges"},
            {"slug": "moderate_content", "description": "Can moderate community content and forums"},
            {"slug": "review_prs", "description": "Can review and merge student pull requests"},
        ]
        ...
        roles_data = {
            "Administrator": ["manage_roles", "view_audit_logs", "manage_users", "create_content", "moderate_content", "review_prs"],
        ...
        for role_name, perms in roles_data.items():
            role, created = Role.objects.get_or_create(
                name=role_name,
                defaults={"is_system_role": True, "description": f"System role for {role_name}"}
            )
