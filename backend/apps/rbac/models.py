...
class AuditLog(models.Model):
    objects = models.Manager()
    actor = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="rbac_actions_performed")
    target_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="rbac_actions_received")
