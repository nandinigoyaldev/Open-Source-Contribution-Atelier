...
```
Error: A snapshot doesn't exist at X:\SSOC\Open-Source-Contribution-Atelier\frontend\e2e\layouts\signup.spec.ts-snapshots\signup-full-mobile-chrome-win32.png, writing actual.
```
