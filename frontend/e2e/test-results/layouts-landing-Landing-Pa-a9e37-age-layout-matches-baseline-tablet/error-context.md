...
```
Error: A snapshot doesn't exist at X:\SSOC\Open-Source-Contribution-Atelier\frontend\e2e\layouts\landing.spec.ts-snapshots\landing-full-tablet-win32.png, writing actual.
```
