...
- Name: layouts\responsive.spec.ts >> Responsive Layout Validation >> 404 page adapts to current viewport
- Location: e2e\layouts\responsive.spec.ts:17:3

# Error details

```
Error: A snapshot doesn't exist at X:\SSOC\Open-Source-Contribution-Atelier\frontend\e2e\layouts\responsive.spec.ts-snapshots\responsive-not-found-desktop-chrome-win32.png, writing actual.
```
