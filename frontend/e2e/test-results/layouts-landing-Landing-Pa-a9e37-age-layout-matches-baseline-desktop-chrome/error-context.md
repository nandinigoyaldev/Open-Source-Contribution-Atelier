...
- Name: layouts\landing.spec.ts >> Landing Page Layout >> full page layout matches baseline
- Location: e2e\layouts\landing.spec.ts:13:3

# Error details

```
Error: A snapshot doesn't exist at X:\SSOC\Open-Source-Contribution-Atelier\frontend\e2e\layouts\landing.spec.ts-snapshots\landing-full-desktop-chrome-win32.png, writing actual.
```
