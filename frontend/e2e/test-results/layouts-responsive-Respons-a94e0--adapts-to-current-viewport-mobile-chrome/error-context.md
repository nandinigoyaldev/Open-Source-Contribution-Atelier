...
```
Error: A snapshot doesn't exist at X:\SSOC\Open-Source-Contribution-Atelier\frontend\e2e\layouts\responsive.spec.ts-snapshots\responsive-landing-mobile-chrome-win32.png, writing actual.
```
