...
- Name: layouts\responsive.spec.ts >> Responsive Layout Validation >> landing page adapts to current viewport
- Location: e2e\layouts\responsive.spec.ts:12:3

# Error details

```
Error: A snapshot doesn't exist at X:\SSOC\Open-Source-Contribution-Atelier\frontend\e2e\layouts\responsive.spec.ts-snapshots\responsive-landing-desktop-chrome-win32.png, writing actual.
```
...
- generic [ref=e4]:
  ...
  - generic [ref=e7]:
    - generic [ref=e8]:
      ...
      - button "Maintainer" [ref=e10] [cursor=pointer]
    - heading "Enter the Sandbox." [level=2] [ref=e11]
