...
- Name: dashboard.spec.ts >> Dashboard Core Workflows >> User can logout from dashboard
...
Call log:
  - Expect "not toHaveURL" with timeout 5000ms
    12 × unexpected value "http://localhost:5173/dashboard"
...
- dialog "Confirm Logout":
  - heading "Confirm Logout" [level=2]
