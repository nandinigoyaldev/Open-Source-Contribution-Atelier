...
- Name: layouts\login.spec.ts >> Login Page Layout >> full page layout matches baseline
- Location: e2e\layouts\login.spec.ts:12:3

# Error details

```
Error: A snapshot doesn't exist at X:\SSOC\Open-Source-Contribution-Atelier\frontend\e2e\layouts\login.spec.ts-snapshots\login-full-desktop-chrome-win32.png, writing actual.
```
