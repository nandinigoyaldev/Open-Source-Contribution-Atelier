...
```
Error: A snapshot doesn't exist at X:\SSOC\Open-Source-Contribution-Atelier\frontend\e2e\layouts\responsive.spec.ts-snapshots\responsive-not-found-tablet-win32.png, writing actual.
```
